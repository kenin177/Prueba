...
namespace Snake
{
    public partial class Form1 : Form
    {
        ...
        private void configuracionRanking(string nombre, int puntaje) //aca sale el ranking del puntaje de snake
        {
            ...
            if (puntaje > RRHHPlanilla.Properties.Settings.Default.puntajeTop3)
            {
                if (puntaje > RRHHPlanilla.Properties.Settings.Default.puntajeTop2)
                {
                    if (puntaje > RRHHPlanilla.Properties.Settings.Default.puntajeTop1)
                    {
                        RRHHPlanilla.Properties.Settings.Default.nombreTop3 = RRHHPlanilla.Properties.Settings.Default.nombreTop2;
                        RRHHPlanilla.Properties.Settings.Default.puntajeTop3 = RRHHPlanilla.Properties.Settings.Default.puntajeTop2;
                        RRHHPlanilla.Properties.Settings.Default.nombreTop2 = RRHHPlanilla.Properties.Settings.Default.nombreTop1;
                        RRHHPlanilla.Properties.Settings.Default.puntajeTop2 = RRHHPlanilla.Properties.Settings.Default.puntajeTop1;

                        RRHHPlanilla.Properties.Settings.Default.nombreTop1 = nombre;
                        RRHHPlanilla.Properties.Settings.Default.puntajeTop1 = puntaje;
                    }
                    else
                    {
                        RRHHPlanilla.Properties.Settings.Default.nombreTop3 = RRHHPlanilla.Properties.Settings.Default.nombreTop2;
                        ...
                        RRHHPlanilla.Properties.Settings.Default.nombreTop2 = nombre;
                        RRHHPlanilla.Properties.Settings.Default.puntajeTop2 = puntaje;
                    }
                }
                else
                {
                    RRHHPlanilla.Properties.Settings.Default.nombreTop3 = nombre;
                    RRHHPlanilla.Properties.Settings.Default.puntajeTop3 = puntaje;
                }
            }
            else
            {
        ...
        private void MostrarRangin()
        {
            ...
            listBox1.Items.Add("Posición 1: " + RRHHPlanilla.Properties.Settings.Default.nombreTop1 + " Tú puntaje es: " + RRHHPlanilla.Properties.Settings.Default.puntajeTop1);
            listBox1.Items.Add("Posición 2: " + RRHHPlanilla.Properties.Settings.Default.nombreTop2 + " Tú puntaje es: " + RRHHPlanilla.Properties.Settings.Default.puntajeTop2);
            listBox1.Items.Add("Posición 3: " + RRHHPlanilla.Properties.Settings.Default.nombreTop3 + " Tú puntaje es: " + RRHHPlanilla.Properties.Settings.Default.puntajeTop3);
